...
This project and everyone participating in it is governed by the HashnodeJS [Code of Conduct](https://github.com/warengonzaga/hashnode.js/blob/master/CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to <opensource@warengonzaga.com>.
...
Answering a question in [Discussions](https://github.com/warengonzaga/hashnode.js/discussions) is one of the easiest ways to start contributing.
